...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <h5 class="text-light mx-3 mb-2 font-weight-bold">Amigos de Hardany</h5>
      <!-- Divider -->
      <hr class="sidebar-divider my-0">

      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="/l_dashboard">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Dashboard lider</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">          
            <a class="collapse-item" href="/l_usuario">Registrar Usuario</a>
            <a class="collapse-item" href="/l_registrarlider">Ver Usuario</a>
   ...
   <li class="nav-item">
    ...
    <div id="collapsereporte" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded"> 
        <a class="collapse-item" href="/l_votosporpuestos">Votos por puestos</a>
        <a class="collapse-item" href="/l_votospormesa">Votos por mesa</a>
        <a class="collapse-item" href="/l_votosporzonas">Votos por zonas</a> 
      </div>
    </div>
  </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="/l_profilechange_password">
