...
class regpersonaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard/lider/index',compact('regiones','departamentos','municipios'));
    }
  ...
  $id_session_user=$request->session()->get('iduser');
    ...
    public function edit($id)
    {
        ...
        $usuario= DB::table('persona')
                        ...
                        ->where('idpersona',$id)
                        ->first(); 
        return view('dashboard.lider.actualizarusuario',compact('regiones','departamentos','municipios','usuario'));
    }
    ...
    public function formchangepass(){
        ...
        return view('dashboard.lider.profile.cambiar_password');
    }

    public function formchangeprofilepass(){
       
        return view('dashboard.lider.profile.changeprofile_password');
    }
